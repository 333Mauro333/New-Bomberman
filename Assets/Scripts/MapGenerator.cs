...
namespace NewBomberman
{
    public class MapGenerator : MonoBehaviour
    {
        ...
        void Awake()
        {
            blocksMap = new char[mapSize, mapSize] { { unBck, unBck, unBck, unBck, unBck, unBck, unBck, unBck },
                                                     { unBck, plyr1, empty, empty, empty, empty, empty, unBck },
                                                     { unBck, empty, unBck, empty, empty, unBck, empty, unBck },
                                                     { unBck, empty, empty, empty, empty, empty, empty, unBck },
                                                     { unBck, empty, empty, empty, empty, empty, empty, unBck },
                                                     { unBck, empty, unBck, empty, empty, unBck, empty, unBck },
                                                     { unBck, empty, empty, empty, empty, empty, empty, unBck },
                                                     { unBck, unBck, unBck, unBck, unBck, unBck, unBck, unBck }};
        }
        void Start()
        {
